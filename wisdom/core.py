...
class reweight :
    ...
    def __init__(self, datapath, num_classes, feat_model='nn', metric='f1') :

        """Re-weightingof generated Labelling Functions : WISDOM
    ...
    def __call__(self, num_runs, batch_size=32, lr_lr=0.0003, gm_lr=0.01) : 
